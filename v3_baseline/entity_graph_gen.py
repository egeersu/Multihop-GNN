...
print('Dataset loaded! with size:', len(data[20000:29999]), flush=True)
...
for i_d, d in enumerate(tqdm(data[20000:29999])):
...
#         print(d['nodes_candidates_id'])
    ...
    #         print(d['edges_COMPLETE'])
        ...
        if (i_d+1) % 500 == 0:
            ...
            file = open('removed_samples_id_20000_30000.txt','w')
