...
def get_args():
    ...
    parser.add_argument('--use-gpu', default=False, help='if use GPU, need cuda.')
    ...
    parser.add_argument('--dataset', type=str, default="train", help='specify generate graph for which dataset.')
